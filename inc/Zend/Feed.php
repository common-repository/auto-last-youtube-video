...
class Zend_Feed
{
    ...
    public static function importString($string)
    {
        ...
        if ($doc->getElementsByTagName('feed')->item(0) ||
             ...
             * @see Zend_Feed_Atom
             */
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc/Zend/Feed/Atom.php';
        ...
        if ($doc->getElementsByTagName('channel')->item(0)) {
             ...
             * @see Zend_Feed_Rss
             */
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc/Zend/Feed/Rss.php';
    ...
    public static function importArray(array $data, $format = 'atom')
    {
         ...
         */
        require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc/Zend/Feed/Builder.php';
