 ...
 * @see Zend_Feed
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed.php';

/**
 * @see Zend_Feed_Reader_Feed_Rss
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Reader/Feed/Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Reader/Feed/Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Reader/FeedSet.php';
...
class Zend_Feed_Reader
{
    ...
    public static function getHttpClient()
    {
        if (!self::$_httpClient instanceof Zend_Http_Client) {
             ...
             */
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Client.php';
    ...
    public static function getPluginLoader()
    {
        if (!isset(self::$_pluginLoader)) {
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader/PluginLoader.php';
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Feed_Reader_Extension_' => AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Reader/Extension/',
            ));
        }
