 ...
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Abstract.php';
...
class Zend_Feed_Pubsubhubbub
{
    ...
    public static function detectHubs($source)
    {
        if (is_string($source)) {
            ...
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Pubsubhubbub/Exception.php';
