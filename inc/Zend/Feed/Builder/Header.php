 ...
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Builder/Header/Itunes.php';
...
class Zend_Feed_Builder_Header extends ArrayObject
{
    ...
    public function setEmail($email)
    {
         ...
         */
        require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Validate/EmailAddress.php';
        $validate = new Zend_Validate_EmailAddress();
        if (!$validate->isValid($email)) {
            /**
             * @see Zend_Feed_Builder_Exception
             */
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Feed/Builder/Exception.php';
    ...
    public function setTtl($ttl)
    {
         ...
         */
        require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Validate/Int.php';
