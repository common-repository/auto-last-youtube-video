...
class Zend_Validate_Barcode extends Zend_Validate_Abstract
{
    ...
    public function __construct($adapter)
    {
        ...
        if (is_array($adapter)) {
            ...
            if (array_key_exists('adapter', $adapter)) {
                ...
                require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Validate/Exception.php';
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader.php';
        if (Zend_Loader::isReadable(AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Validate/Barcode/' . $adapter. '.php')) {
