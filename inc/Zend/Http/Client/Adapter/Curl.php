 ...
 * @see Zend_Uri_Http
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Uri/Http.php';
 ...
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Client/Adapter/Stream.php';
...
class Zend_Http_Client_Adapter_Curl implements Zend_Http_Client_Adapter_Interface, Zend_Http_Client_Adapter_Stream
{
    ...
    public function __construct()
    {
        if (!extension_loaded('curl')) {
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Client/Adapter/Exception.php';
