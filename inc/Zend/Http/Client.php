 ...
 * @see Zend_Loader
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader.php';
 ...
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Response/Stream.php';
...
class Zend_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Zend_Uri_Http) {
            ...
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Client/Exception.php';
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Zend_Http_CookieJar')) {
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/CookieJar.php';
        }
    ...
    public function setCookie($cookie, $value = null)
    {
        if (! class_exists('Zend_Http_Cookie')) {
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Http/Cookie.php';
        }
