...
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader/PluginLoader/Interface.php';
...
class Zend_Loader_PluginLoader implements Zend_Loader_PluginLoader_Interface
{
    ...
    public function addPrefixPath($prefix, $path)
    {
        if (!is_string($prefix) || !is_string($path)) {
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader/PluginLoader/Exception.php';
