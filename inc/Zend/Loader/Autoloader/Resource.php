...
require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader/Autoloader/Interface.php';
...
class Zend_Loader_Autoloader_Resource implements Zend_Loader_Autoloader_Interface
{
    ...
    public function __construct($options)
    {
        ...
        if (!is_array($options)) {
            require_once AUTO_LAST_YOUTUBE_VIDEO_PATH.'inc///Zend/Loader/Exception.php';
